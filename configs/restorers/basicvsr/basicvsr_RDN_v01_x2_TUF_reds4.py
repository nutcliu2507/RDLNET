exp_name = 'basicvsr_RDN_v01_x2_reds4'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='D:/AI_master/SR_datasets/REDS/train_sharp_bicubic/X2',
            num_input_frames=15,
    ...
    val=dict(
        ...
        gt_folder='D:/AI_master/SR_datasets/REDS4/sharp_bicubic/X2',
...
load_from = None
# resume_from = f'./work_dirs/{exp_name}/iter_150000.pth'
resume_from = None
workflow = [('train', 1)]
