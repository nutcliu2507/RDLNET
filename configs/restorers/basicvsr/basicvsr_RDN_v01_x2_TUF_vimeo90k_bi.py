exp_name = 'basicvsr_RDN_v01_x2_vimeo90k_bi'

# model settings
model = dict(
    type='BasicVSR',
    generator=dict(
        type='BasicVSRNet_RDN_v01_x2',
        mid_channels=32,
        num_blocks=30,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            gt_folder='D:/AI_master/SR_datasets/vimeo_90k/vimeo_septuplet/sequences_BIx2',
            ann_file='data/vimeo90k/meta_info_Vimeo90K_train_GT_x2.txt',
    ...
    val=dict(
        ...
        gt_folder='D:/AI_master/SR_datasets/Vid4/BIx2',
    ...
    test=dict(
        ...
        gt_folder='D:/AI_master/SR_datasets/vimeo_90k/vimeo_super_resolution_test/low_resolution_x2',
        ann_file='data/vimeo90k/meta_info_Vimeo90K_test_GT_02_x2.txt',
