exp_name = 'basicvsr_RDN_v11_S4_reds4'
...
train_cfg = dict(fix_iter=5000, tsa_iter=50000)
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='D:/AI_master/SR_datasets/REDS/train_sharp_bicubic/X4',
            gt_folder='D:/AI_master/SR_datasets/REDS/train_sharp',
            num_input_frames=15,
    ...
    val=dict(
        ...
        lq_folder='D:/AI_master/SR_datasets/REDS4/sharp_bicubic/X4',
        gt_folder='D:/AI_master/SR_datasets/REDS4/GT',
...
load_from = None
resume_from = None
# resume_from = 'work_dirs/basicvsr_RDN_v11_S4_reds4/iter_205000.pth'
